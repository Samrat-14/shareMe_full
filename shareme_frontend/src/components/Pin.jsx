                ...
                {postHovered && (
                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            {alreadySaved ? (
                                <button type="button" className="flex flex-row items-center bg-red-500 opacity-70 hover:opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow:md outlined-none">
                                    {save?.length}  <AiFillHeart className="ml-1 text-xl" />
                                </button>
                            ) : (
                                <button 
                                    onClick={(e) => {
